...
//ltl obl1 { [] ( ((Car[0]@entry) && [] !(Car[1]@entry || Car[3]@entry || Car[3]@entry) ) -> <> (Car[0]@crit) )} // Works
//ltl res { [] ( (Car[0]@entry || Car[1]@entry || Car[2]@entry || Car[3]@entry) -> <> (Car[0]@crit || Car[1]@crit || Car[2]@crit || Car[3]@crit) )} // Works
//ltl fair1 { []( (Car[0]@entry) -> <> (Car[0]@crit) ) } // Fails
